...
namespace WF___medici_pacienti
{
    public partial class Form1 : Form
    {
        ...
        {
            Pacient mForm1 = null;
            FormPacient fm = new FormPacient(mForm1);
            fm.ShowDialog();
            if (fm.DialogResult == DialogResult.OK)
            {
                mForm1 = fm.mFormPacient;
                ListViewItem lv = new ListViewItem();
                lv = new ListViewItem(new string[]
                { mForm1.NumePrenume, mForm1.Cnp, mForm1.CardSanatate });
                lv.Tag = mForm1;
                listView1.Items.Add(lv);
            }
        }

        private void buttonEditeazaPacient_Click(object sender, EventArgs e)
        {
            Pacient mForm1 = (Pacient)listView1.SelectedItems[0].Tag;
            ...
            if (fm.DialogResult == DialogResult.OK)
            {
                ...
                lv.Text = mForm1.NumePrenume;
                lv.SubItems[1].Text = mForm1.Cnp;
                lv.SubItems[2].Text = mForm1.CardSanatate;
